...
from app.api import auth, favorites, library, progress, streams, xtream
...
def ensure_dirs() -> None:
    dirs = [settings.movies_dir, settings.shows_dir, settings.live_dir, settings.downloads_dir]
    ...
    # Docker compose mounts /data — create when writable
...
# Optional static frontend (served from /app/static in Docker)
