...
describe('schema migrations 014–017', () => {
  it('registers onboarding, profile body, weekly review, and cleanup migrations in order', async () => {
  ...
  it('includes SQL files for migrations 014–017', () => {
